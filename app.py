...
files = [
    "src/traiding 01-02-2023_part1.txt",
    "src/traiding 01-02-2023_part2.txt",
    "src/traiding 01-02-2023_part3.txt"
]
...
resultados_ml = pd.read_csv('src/results_project_models.csv')
...
if __name__ == '__main__':
    port = int(os.environ.get("PORT", 8080))  # Render asigna un puerto en esta variable de entorno
